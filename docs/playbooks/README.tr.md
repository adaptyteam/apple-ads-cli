...
Amiral gemisi oyun kitaplarının okunabilir sürümleri — hiçbir şey kurmadan burada okuyabilirsiniz.
Yetkili kopyalar `skills/` altındadır; bu sayfa onlardan üretilir.

[English](README.md) · [简体中文](README.zh-CN.md) · **Türkçe**

| Oyun kitabı | Ne işe yarar | Kaynak |
|---|---|---|
...
| Negatif madenciliği | geçerli amacı bozmadan ilgisiz veya yanlış sahiplenilmiş trafiği engelleme | [`negative-keyword-hygiene.md`](../../skills/apple-ads/references/playbooks/negative-keyword-hygiene.md) |
| CPP yönlendirme | sorgu amacını mevcut bir Özel Ürün Sayfası ve reklamla eşleştirme | [`creative-setup.md`](../../skills/apple-ads/references/playbooks/creative-setup.md) |
| Kontrolsüz harcama | en küçük doğru hamleyle kanamayı durdurma | [`runaway-spend.md`](../../skills/apple-ads/references/playbooks/runaway-spend.md) |
| Evrensel TV kumandası | uçtan uca eksiksiz bir dikey rehber | [`utility-tv-remote.md`](../../skills/apple-ads-strategy/references/verticals/utility-tv-remote.md) |

> Oyun kitaplarının kendi çevirileri henüz yapılmadı; şimdilik yalnızca dizin çevrildi. Bu deponun
> kuralı: insana bakan sayfalar çevrilir, ajana bakan talimatlar İngilizce kalır.
