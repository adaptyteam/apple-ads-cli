---
title: Custom product page to ad
intent: user wants a CPP attached to an ad group
kind: procedural
risk: writes-money
requires: { cli: ">=0.4.0", subscription: true }
uses: [asa product-pages sync, asa product-pages list, asa creatives list, asa ads create]
time: TODO
---

# Custom product page to ad
