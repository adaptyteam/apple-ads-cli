---
title: Load a keyword list into an ad group
intent: user has a keyword list and wants it in the account
kind: procedural
risk: writes-money
requires: { cli: ">=0.4.0", subscription: true }
uses: [asa keywords add, asa negative-keywords add]
time: TODO
---

# Load a keyword list into an ad group
